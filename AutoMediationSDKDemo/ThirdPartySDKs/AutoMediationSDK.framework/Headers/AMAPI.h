...
extern NSString *const AMADLoadingErrorDomain;
extern NSInteger const AMADLoadingErrorCodePlacementStrategyInvalidResponse;
extern NSInteger const AMADLoadingErrorCdoePlacementStragetyNetworkError;
extern NSInteger const AMADLoadingErrorCodeADOfferLoadingFailed;
extern NSInteger const AMADLoadingErrorCodePlacementStrategyNotFound;
extern NSInteger const AMADLoadingErrorCodeADOfferNotFound;
extern NSInteger const AMADLoadingErrorCodeShowIntervalWithinPlacementPacing;
extern NSInteger const AMADLoadingErrorCodeShowTimesExceedsHourCap;
extern NSInteger const AMADLoadingErrorCodeShowTimesExceedsDayCap;
extern NSInteger const AMADLoadingErrorCodeAdapterClassNotFound;
extern NSInteger const AMADLoadingErrorCodeADOfferLoadingTimeout;
extern NSInteger const AMADLoadingErrorCodeSDKNotInitalizedProperly;
extern NSInteger const AMADLoadingErrorCodeDataConsentForbidden;
extern NSInteger const AMADLoadingErrorCodeThirdPartySDKNotImportedProperly;
extern NSInteger const AMADLoadingErrorCodeInvalidInputEncountered;
extern NSInteger const AMADLoadingErrorCodePlacementAdDeliverySwitchOff;

extern NSString *const AutoMediationSDKInitErrorDomain;
extern NSInteger const AutoMediationSDKInitErrorCodeDataConsentNotSet;
extern NSInteger const AutoMediationSDKInitErrorCodeDataConsentForbidden;
...
typedef NS_ENUM(NSInteger, AMDataConsentSet) {
    ...
    AMDataConsentSetUnknown = 0,
    AMDataConsentSetPersonalized = 1,
    AMDataConsentSetNonpersonalized = 2,
    AMDataConsentSetForbidden = 3
};

@interface AMAPI : NSObject
 ...
 */
-(void) setDataConsentSet:(AMDataConsentSet)dataConsentSet consentString:(NSDictionary<NSString*, NSString*>*)consentString;
/**
...
@property(nonatomic, readonly) AMDataConsentSet dataConsentSet;
